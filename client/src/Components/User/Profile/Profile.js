...
const Profile = () => {
  ...
  return (
    ...
    <div className="h-[271px] flex items-start flex-col justify-center gap-7 w-full">
      ...
      <div className="w-full h-16 flex flex-col gap-1"><span className="font-bold">Email</span><span className="px-2 text-white h-full w-full border roundedemail">{email}</span></div>
    </div>
    </div>
  )
}
